...
/**
 * <p>Classe Java pour listeComtesResponse complex type.</p>
 * 
 * <p>Le fragment de schéma suivant indique le contenu attendu figurant dans cette classe.</p>
 * 
 * <pre>{@code
 * <complexType name="listeComtesResponse">
 *   <complexContent>
...
@XmlType(name = "listeComtesResponse", propOrder = {
    "_return"
})
public class ListeComtesResponse {
