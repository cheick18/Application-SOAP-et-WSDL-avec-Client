 ...
 *       <sequence>
 *         <element name="codeAnInt" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
public class Compte {
    ...
    protected int codeAnInt;
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar dateCreation;
    protected double solde;

    /**
     * Obtient la valeur de la propriété codeAnInt.
     * 
     */
    ...
    /**
     * Définit la valeur de la propriété codeAnInt.
     * 
     */
    public void setCodeAnInt(int value) {
        this.codeAnInt = value;
    }
