...
public interface BanqueService {
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "listeComtes", targetNamespace = "http://ws/", className = "proxy.ListeComtes")
    @ResponseWrapper(localName = "listeComtesResponse", targetNamespace = "http://ws/", className = "proxy.ListeComtesResponse")
    @Action(input = "http://ws/BanqueService/listeComtesRequest", output = "http://ws/BanqueService/listeComtesResponse")
